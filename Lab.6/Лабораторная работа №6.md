...
## 2. Зарегестрировался на сайте [openweathermap](https://openweathermap.org/) для получения токена b65b8e60ec93fc8fa404bfeff739cde7.
...
## 4. Проверил работу написанного кода в браузере.
